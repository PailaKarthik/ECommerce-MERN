  ...
  return (
    <div className=" flex items-center justify-center">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-md bg-gray-800 rounded-3xl"
      >
        {/* Main Card */}
        ...
        <motion.div
          ...
          className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-full blur-xl"
        />
        <motion.div
          initial={{ opacity: 0, scale: 0 }}
          animate={{ opacity: 1, scale: 1 }}
